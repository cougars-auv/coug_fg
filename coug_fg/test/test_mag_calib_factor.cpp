...
TEST(MagCalibFactorArmTest, Jacobians) {
  ...
  MagCalibFactorArm factor(pose_key, bias_key, measured_field, reference_field, target_T_sensor,
                           model);
...
TEST(MagCalibFactorArmTest, Residual) {
  ...
  MagCalibFactorArm factor(pose_key, bias_key, sensor_field + bias - offset, reference_field,
