...
TEST(BearingFactorArmTest, Jacobians) {
  ...
  coug_fg::factors::BearingFactorArm factor(pose_key_l, pose_key_n, measured_azi_el,
...
TEST(BearingFactorArmTest, Residual) {
  ...
  coug_fg::factors::BearingFactorArm factor(pose_key_l, pose_key_n,
  ...
  coug_fg::factors::BearingFactorArm tilted(pose_key_l, pose_key_n,
