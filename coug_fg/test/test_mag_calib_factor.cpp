...
TEST(MagCalibFactorArmTest, Jacobians) {
  ...
  coug_fg::factors::MagCalibFactorArm factor(pose_key, bias_key, measured_field, reference_field,
...
TEST(MagCalibFactorArmTest, Residual) {
  ...
  coug_fg::factors::MagCalibFactorArm factor(pose_key, bias_key, sensor_field + bias - offset,
