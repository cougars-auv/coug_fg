...
TEST(BearingOriginDeltaFactorArmTest, Jacobians) {
  ...
  coug_fgo::factors::BearingOriginDeltaFactorArm factor(pose_key_l, delta_key_n, pose_key_n,
...
TEST(BearingOriginDeltaFactorArmTest, Residual) {
  ...
  coug_fgo::factors::BearingOriginDeltaFactorArm factor(
      pose_key_l, delta_key_n, pose_key_n, gtsam::Point2(azimuth, elevation), target_T_sensor_l,
      target_T_sensor_n, model);
  ...
  coug_fgo::factors::BearingOriginDeltaFactorArm tilted(
      pose_key_l, delta_key_n, pose_key_n, gtsam::Point2(azimuth, elevation - kOffset),
