...
TEST(BearingFactorArmTest, Jacobians) {
  ...
  BearingFactorArm factor(pose_key_l, pose_key_n, measured_azi_el, target_T_sensor_l,
...
TEST(BearingFactorArmTest, Residual) {
  ...
  BearingFactorArm factor(pose_key_l, pose_key_n, gtsam::Point2(azimuth, elevation),
  ...
  BearingFactorArm tilted(pose_key_l, pose_key_n, gtsam::Point2(azimuth, elevation - kOffset),
                          target_T_sensor_l, target_T_sensor_n, model);
